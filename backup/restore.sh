...
cekdata=$(curl -sS https://raw.githubusercontent.com/keluargacobain/userbackupcobain/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/keluargacobain/userbackupcobain/main/$NameUser/$NameUser.zip" &> /dev/null
...
sleep 1
cp -r /root/backup/cobainvpn-pro /var/lib/ &> /dev/null
cp -r /root/backup/.acme.sh /root/ &> /dev/null
cp -r /root/backup/cobainvpn /etc/ &> /dev/null
