...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/keluargacobain/multiws/main/ssh/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/keluargacobain/multiws/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
Login=ajikcobainvpn`</dev/urandom tr -dc X-Z0-9 | head -c4`
hari="1"
Pass=1
