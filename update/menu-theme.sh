...
01 | 1)
clear
echo "blue" >/etc/cobainvpn/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
02 | 2)
clear
echo "red" >/etc/cobainvpn/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
03 | 3)
clear
echo "yellow" >/etc/cobainvpn/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
04 | 4)
clear
echo "cyan" >/etc/cobainvpn/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
05 | 5)
clear
echo "green" >/etc/cobainvpn/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
06 | 6)
clear
echo "magenta" >/etc/cobainvpn/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
